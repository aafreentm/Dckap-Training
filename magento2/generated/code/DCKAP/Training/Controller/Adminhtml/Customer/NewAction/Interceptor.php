<?php
namespace DCKAP\Training\Controller\Adminhtml\Customer\NewAction;

/**
 * Interceptor class for @see \DCKAP\Training\Controller\Adminhtml\Customer\NewAction
 */
class Interceptor extends \DCKAP\Training\Controller\Adminhtml\Customer\NewAction implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function initPage($resultPage)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('initPage', func_get_args(), $pluginInfo) : parent::initPage($resultPage);
    }
